...
export class SensorCameraControl {
    ...
    removeEvents() {
        ...
        this.domElement.removeEventListener("touchstart", this.bindtouchdown);
        this.domElement.removeEventListener("touchend", this.bindtouchup);
    ...
    onTouchDown(event) {
        this.domElement.addEventListener("touchmove", this.bindtouchmove, false);
        this._prevMouseX = event.touches[ 0 ].pageX;
        this._prevMouseY = event.touches[ 0 ].pageY;
    }

    onTouchMove(event) {
        let movementX = this._prevMouseX ? event.touches[ 0 ].pageX - this._prevMouseX : 0;
        let movementY = this._prevMouseY ? event.touches[ 0 ].pageY - this._prevMouseY : 0;
        // euler旋转顺序 y z x
        // euler.x~y轴旋转
        // euler.y~z轴旋转
        this._euler.y -= movementX * this.lookSpeed;
    ...
    onTouchUp(event) {
        this.domElement.removeEventListener("touchmove", this.bindtouchmove);
    }
